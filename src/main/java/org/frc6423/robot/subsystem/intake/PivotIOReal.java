...
/** {@link PivotIO} extension for real hardware (Kraken x60) */
public class PivotIOReal extends PivotIO {
  ...
  public PivotIOReal(int canDeviceId, CANBus canBus, TalonFXConfiguration config) {
